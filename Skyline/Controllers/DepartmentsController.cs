...
namespace Skyline.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var department = await _context.Departments.Include(dept => dept.Employees)
        ...
        {
            var department = await _context.Departments.Include(dept => dept.Employees).FirstOrDefaultAsync(e => e.Id==id);
            if (department != null)
            {
